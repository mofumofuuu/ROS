...
class AddTwolntsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddTwolntsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddTwolntsRequest
    let len;
    let data = new AddTwolntsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddTwolntsRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class AddTwolntsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddTwolntsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddTwolntsResponse
    let len;
    let data = new AddTwolntsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddTwolntsResponse(null);
...
module.exports = {
  Request: AddTwolntsRequest,
  Response: AddTwolntsResponse,
  md5sum() { return '6a2e34150c00229791cc89ff309fff21'; },
  datatype() { return 'learning_communication/AddTwolnts'; }
};
